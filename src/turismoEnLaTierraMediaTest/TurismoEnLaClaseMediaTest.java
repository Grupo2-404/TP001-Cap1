...
public class TurismoEnLaClaseMediaTest {
	...
	public void queAlCrearUnUsuarioSeCreeCorrectamente() {
		...
		Usuario Axel = new Usuario("Axel", TipoDeAtraccion.AVENTURA, 10000, 12.00);				// Revisar excepciones. Que falló?
		Usuario Bruno = new Usuario("Bruno", TipoDeAtraccion.DEGUSTACIÓN, 5000, 4.00);
	...
	public void queAlNoTenerTiempoOdineroDeError() {
		...
		Usuario Bruno = new Usuario("Bruno", TipoDeAtraccion.DEGUSTACIÓN, 5000, 3);
	}
